<template>
  ...
  <!-- <h2 style="text-align: center">Signifiez vos actes simplement</h2>
    ...
    <div class="pa-5 home3 text-xs-left">
      <h2 class="pt-4 text-xs-center mb-4">Essayez iSignif gratuitement <br><small>ou passez au Premium pour une utilisation illimitée</small></h2>
      <v-layout row align-center>

        <v-flex lg class="pa-4 mycard">
          <div style="float: right">
            <v-card class="pa-3">
              <v-card-title class="pb-0">iSignif Basique</v-card-title>
              ...
              <v-card-actions class="text-xs-center">
                <v-btn text class="primary freemium_btn ma-auto">Inscrivez-vous</v-btn>
              </v-card-actions>
            </v-card>
          </div>
        </v-flex>
    ...
    <div class="pa-5 home4">
      <h2 class="pt-4 text-xs-center mb-5">Ils nous font confiance</h2>
      <br>
      <v-layout row align-center>
